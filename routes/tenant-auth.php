...
Route::middleware('guest')->group(function () {
    ...
    Route::get('tanent-login', [AuthenticatedSessionController::class, 'create'])
                ->name('tanent.login');

    Route::post('tenant-login', [AuthenticatedSessionController::class, 'store'])->name('tenant.login');
